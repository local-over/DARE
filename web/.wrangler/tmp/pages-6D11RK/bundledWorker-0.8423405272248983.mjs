...
var q = /* @__PURE__ */ __name((e, t, a) => (a = e != null ? ae(ie(e)) : {}, ce(t || !e || !e.__esModule ? H(a, "default", { value: e, enumerable: true }) : a, e)), "q");
var g;
var l = M(() => {
  g = { collectedLocales: [] };
});
...
async function J(e) {
  ...
  try {
    ...
    switch (e.method) {
      case "GET": {
        let i = K(e, ge), r = await s.get(n, { softTags: i });
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.8423405272248983.mjs.map
